...
TEST(MessageModelTest, TestValidSetGet) {
    ...
    EXPECT_TRUE(model->set_data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx), FieldPath::FieldNumber(Person::kPreferredPhoneFieldNumber), FieldPath::FieldNumber(PhoneNumber::kTypeFieldNumber)), PhoneNumber::HOME));
    EXPECT_EQ(model->data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx), FieldPath::FieldNumber(Person::kPreferredPhoneFieldNumber), FieldPath::FieldNumber(PhoneNumber::kTypeFieldNumber))).toInt(), PhoneNumber::HOME);
    EXPECT_EQ(org.employees(employee_idx).preferred_phone().type(), PhoneNumber::HOME);
...
TEST(MessageModelTest, TestAddRemoveRow) {
    ...
    // Set OrganizationTestSchema.employees[1].name
    EXPECT_TRUE(model->set_data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx2), FieldPath::FieldNumber(Person::kNameFieldNumber)), "Stuff Jane"));
    EXPECT_EQ(model->data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx2), FieldPath::FieldNumber(Person::kNameFieldNumber))).toString(), "Stuff Jane");
    EXPECT_EQ(org.employees(employee_idx2).name(), "Stuff Jane");

    // Remove the first row from OrganizationTestSchema.employees
    EXPECT_TRUE(employees->remove_row(employee_idx));
    EXPECT_EQ(employees->rowCount(), 1);

    // Try to set second row after removing the first row
    EXPECT_FALSE(model->set_data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx2), FieldPath::FieldNumber(Person::kNameFieldNumber)), "Stuff Jane"));
    EXPECT_FALSE(model->data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx2), FieldPath::FieldNumber(Person::kNameFieldNumber))).isValid());

    // Read the first row name now
    EXPECT_EQ(model->data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx), FieldPath::FieldNumber(Person::kNameFieldNumber))).toString(), "Stuff Jane");
    EXPECT_EQ(org.employees(employee_idx).name(), "Stuff Jane");
...
TEST(MessageModelTest, TestOneofModel) {
    ...
    // Set preferred_email
    EXPECT_TRUE(model->set_data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx), FieldPath::FieldNumber(Person::kPreferredEmailFieldNumber)), "rf@pl,ck"));
    EXPECT_EQ(model->data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx), FieldPath::FieldNumber(Person::kPreferredEmailFieldNumber))).toString(), "rf@pl,ck");
    EXPECT_EQ(org.employees(employee_idx).preferred_email(), "rf@pl,ck");

    // Get preferred_phone.number
    EXPECT_FALSE(model->data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx), FieldPath::FieldNumber(Person::kPreferredPhoneFieldNumber), FieldPath::FieldNumber(PhoneNumber::kNumberFieldNumber))).isValid());
    ...
    // Get preferred_email
    EXPECT_FALSE(model->data(FieldPath::Of<OrganizationTestSchema>(FieldPath::FieldNumber(OrganizationTestSchema::kEmployeesFieldNumber), FieldPath::RepeatedAt(employee_idx), FieldPath::FieldNumber(Person::kPreferredEmailFieldNumber))).isValid());
}
