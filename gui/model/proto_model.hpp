...
class ProtoModel : public QAbstractItemModel {
 ...
 public:
  ...
  /**
     ...
     */
  virtual const ProtoModel* get_sub_model(
      const FieldPath& path, const bool& for_set_data = false,
      const bool& for_get_oneof = false) const = 0;  // A read-only version of ProtoModel
  ...
  /**
     ...
     * @return QModelIndex 
     */
  virtual QModelIndex index([[maybe_unused]] int row, [[maybe_unused]] int column,
  ...
  virtual bool setHeaderData([[maybe_unused]] int section, [[maybe_unused]] Qt::Orientation orientation,
                             [[maybe_unused]] const QVariant& value,
                             [[maybe_unused]] int role = Qt::EditRole) override {
    return false;
  }

  virtual QMap<int, QVariant> itemData([[maybe_unused]] const QModelIndex& index) const override {
    return QMap<int, QVariant>();
  }
  virtual bool setItemData([[maybe_unused]] const QModelIndex& index,
                           [[maybe_unused]] const QMap<int, QVariant>& roles) override {
    return false;
  }
 ...
 protected:
  ...
  virtual bool insertRows(int row, [[maybe_unused]] int count, const QModelIndex& parent = QModelIndex()) override {
    return false;
  }
  virtual bool removeRows(int row, [[maybe_unused]] int count, const QModelIndex& parent = QModelIndex()) override {
    return false;
  }
